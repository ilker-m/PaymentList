              ...
              <thead class="bg-gray-50 sticky top-0 z-10">
                <tr class="text-xs">
                  ...
                  <th class="px-2 py-2 text-left cursor-pointer hover:bg-gray-100" @click="toggleSort('firmaLokasyonu')">
                    Firma Lok. <i :class="getSortIcon('firmaLokasyonu')" class="ml-1"></i>
                  </th>
...
const isCollapsed = ref(false) // For collapsed/expanded state (like Claude UI)
...
onMounted(() => {
  ...
  // Load sidebar state preference (like Claude UI saves preference)
